package com.doctorsoffice.security.config;
...
import com.doctorsoffice.security.auth.RestAuthenticationEntryPoint;
import com.doctorsoffice.security.auth.TokenAuthenticationFilter;
import com.doctorsoffice.service.impl.CustomUserDetailsService;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http
			...
			.authorizeRequests().antMatchers("/auth/**").permitAll()		// /auth/**
								...
								.antMatchers("/api/v1/services").permitAll()
								.antMatchers("/api/v1/medical-workers").permitAll()
	...
	public void configure(WebSecurity web) throws Exception {
		...
		web.ignoring().antMatchers(HttpMethod.GET, "/", "/webjars/**", "/*.html", "favicon.ico", "/**/*.html",
				"/**/*.css", "/**/*.js", "api/v1/services/*","api/v1/services","/api/v1/medical-workers");
	}
